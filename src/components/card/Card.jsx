    ...
    return (
        <div className="card">
            <figure className="card__header">
                <Image src={cardImg} alt={title} width={300} height={300} />
            </figure>
            <div className="card__body">
                <span>
                    <Image src={iconImg} alt={desc} width={40} height={40} />
                </span>
                <div>
                    <h4>{title}</h4>
                    <p>{desc}</p>
...
function CardsSection(props) {
    return (
        <section
            id="cardsSection"
            className="cards__wrap section center bg-blue dream5"
        >
